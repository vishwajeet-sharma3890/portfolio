...
export const ProfileNameWrapper = styled.div<{ screenSize: ScreenSize }>`
  ${props => `
    ...
    font-size: ${props.theme.banner.profile.name.label.fontSize[props.screenSize]};
    ...
    b {
      ...
      font-size: ${props.theme.banner.profile.name.value.fontSize[props.screenSize]};
      font-weight: ${props.theme.banner.profile.name.value.fontWeight};
    }
    
    span {
      color: ${props.theme.banner.profile.position.color};
      font-size: ${props.theme.banner.profile.position.fontSize[props.screenSize]};
